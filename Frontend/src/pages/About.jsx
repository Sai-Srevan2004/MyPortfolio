    ...
    <section id="about" className=" text-white py-20 px-6 flex items-center justify-center min-h-screen">
      <div className="max-w-3xl text-center md:text-left">
        ...
        <p className="mt-6 text-xl text-gray-300 leading-relaxed">
          I am a passionate <span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent font-semibold">
            MERN Stack Developer
          </span> and Computer Science professional dedicated to crafting high-performance web solutions.
        </p>

        <p className="mt-6 text-lg text-gray-400">
          With expertise in <span className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent font-semibold">

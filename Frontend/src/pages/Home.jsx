  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center px-4 max-w-2xl">
        ...
        <a
          href={resume}
          download="Sai_Srevan_Resume.pdf"
          className="px-6 py-3 mt-6 bg-gradient-to-r from-cyan-500 via-blue-600 to-teal-500
            text-white rounded-md font-semibold shadow-lg hover:scale-105
            transition-transform duration-300 animate-waveSlideDelay3"
        >
          <button className="bg-transparent">View Resume</button>
        ...
        {/* Social Links */}
        <div className="flex space-x-6 mt-6 animate-waveSlideDelay4">
          <a
            href={import.meta.env.VITE_GITHUB_LINK}
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-cyan-400 text-3xl transition duration-300"
          >
            <FaGithub />
          </a>
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-teal-400 text-3xl transition duration-300"
          >
            <FaInstagram />
          </a>
        </div>

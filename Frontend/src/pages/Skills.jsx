      ...
      <div className="w-full relative rounded-2xl p-6 md:p-10 md:pb-[100px] text-white bg-gradient-to-br from-black via-gray-900 to-gray-950">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-11">
          {skillsData[category].map((skill) => (
            <div
              key={skill.name}
              className="relative bg-gray-900/80 backdrop-blur-md group transition-transform transform hover:scale-105 border border-teal-400 rounded-xl"
            >
  ...
  return (
    <section id="skills" className="flex items-center justify-center px-4 py-20">
      <div className="max-w-6xl w-full">
        <h2 className="text-5xl sm:text-left font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-teal-400 text-center mb-4">
          Skills
        </h2>
        <p className="text-gray-300 sm:text-left text-lg text-center mb-12">

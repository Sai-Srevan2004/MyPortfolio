      ...
      <div className="w-full relative rounded-2xl p-6 md:p-10 text-white bg-gradient-to-br">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-11">
          {skillsData[category].map((skill) => (
            <div
              key={skill.name}
              className="relative group transition-transform transform hover:scale-105 border border-purple-600 rounded-xl"
  ...
  return (
    <section id="skills" className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-6xl w-full">
        <h2 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 via-indigo-600 to-cyan-400 text-center mb-4">
          Skills
        </h2>
        <p className="text-gray-300 text-lg text-center mb-12">Technologies & Concepts I work with:</p>
        <div className="h-[25rem] md:h-[40rem] relative flex flex-col items-start justify-start mx-auto w-full">
          <Tabs tabs={tabs} />
        </div>
      </div>
    </section>

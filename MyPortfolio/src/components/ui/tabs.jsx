...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-col overflow-hidden md:flex-row items-center sm:justify-start [perspective:1000px] relative sm:overflow-visible no-visible-scrollbar w-full",
          containerClassName
        )}
      >
  ...
  return (
    ...
    >
      {tabs.map((tab, idx) => (
        <motion.div
          key={tab.value}
          ref={isActive(tab) ? activeContentRef : null}
          layoutId={tab.value}
          style={{
            scale: 1 - idx * 0.1,
